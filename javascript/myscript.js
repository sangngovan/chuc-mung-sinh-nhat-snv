...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= " Happy Birthday My Friend " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Bấm vào đây làm gì????:';
document.querySelector('.Description .modal-body').innerHTML = 'Nhầm chỗ rồi =))))</i> ';
